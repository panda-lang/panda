...
public final class ArrayUtils {
    ...
    /**
     * {@link java.lang.Iterable#forEach(java.util.function.Consumer)} for arrays using {@link panda.std.function.ThrowingConsumer}
     *
     * @param array the array to iterate
    ...
    public static Class<?> getBaseClass(Class<?> arrayClass) {
        return getBaseClassWithDimensions(arrayClass).getFirst();
    }
