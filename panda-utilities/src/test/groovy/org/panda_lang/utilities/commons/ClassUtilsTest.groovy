...
class ClassUtilsTest {
    ...
    void selectMostRelated() {
        ...
        Assertions.assertEquals(A.class, ClassUtils.selectMostRelated(classes, A.class).getOrNull());
        Assertions.assertEquals(A.class, ClassUtils.selectMostRelated(classes, B.class).getOrNull());
        Assertions.assertEquals(C.class, ClassUtils.selectMostRelated(classes, C.class).getOrNull());
    }
