...
import org.panda_lang.framework.language.interpreter.pattern.descriptive.wildcard.condition.defaults.DefaultWildcardConditionFactories;
...
/**
 * DescriptivePattern is based on {@link org.panda_lang.framework.language.interpreter.pattern.lexical.LexicalPattern}, enhanced by: <br>
 *
 * <ul>
 *     <li>wildcard condition factories: {@link org.panda_lang.framework.language.interpreter.pattern.descriptive.wildcard.condition.WildcardConditionFactory}</li>
 *     <li>wildcard readers: {@link org.panda_lang.framework.language.interpreter.pattern.descriptive.wildcard.reader.WildcardReader}</li>
 * </ul>
 *
 * Examples: <br><br>
 *
