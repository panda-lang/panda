...
package org.panda_lang.framework.language.interpreter.pattern.descriptive.wildcard.reader;
...
public final class WildcardReaderCompiler {
    ...
    public @Nullable Object extract(Context context, String content, TokenDistributor distributor) {
        for (WildcardReader wildcardReader : pattern.getWildcardReaders()) {
            if (!wildcardReader.match(content)) {
                continue;
            }

            return wildcardReader.read(context, content, distributor);
        }
