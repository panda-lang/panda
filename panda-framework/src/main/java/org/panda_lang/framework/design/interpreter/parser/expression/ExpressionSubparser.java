...
/**
 * Subparsers is extension parser used by the {@link org.panda_lang.framework.design.interpreter.parser.expression.ExpressionSubparser}
 */
public interface ExpressionSubparser extends Parser, Comparable<ExpressionSubparser> {
     ...
     * Used by {@link org.panda_lang.framework.design.interpreter.parser.expression.ExpressionParser} to improve performance.
     *
     ...
     * @return the category
     *
     * @see org.panda_lang.framework.design.interpreter.parser.expression.ExpressionCategory
     */
