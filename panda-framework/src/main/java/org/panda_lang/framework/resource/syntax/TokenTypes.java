...
package org.panda_lang.framework.resource.syntax;
...
public final class TokenTypes {
    ...
    /**
     * Represents {@link org.panda_lang.framework.resource.syntax.separator.Separator}
     */
    public static final TokenType SECTION = add(VALUES, new TokenType("SECTION"));
    /**
     * Represents {@link org.panda_lang.framework.resource.syntax.auxiliary.Identifier}
     */
    public static final TokenType IDENTIFIER = add(VALUES, new TokenType("IDENTIFIER"));
    /**
     * Represents {@link org.panda_lang.framework.resource.syntax.literal.Literal}
     */
    public static final TokenType LITERAL = add(VALUES, new TokenType("LITERAL"));
    /**
     * Represents {@link org.panda_lang.framework.resource.syntax.keyword.Keyword}
     */
    ...
    /**
     * Represents {@link org.panda_lang.framework.resource.syntax.sequence.Sequence}
     */
    public static final TokenType SEQUENCE = add(VALUES, new TokenType("SEQUENCE"));
    /**
     * Represents {@link org.panda_lang.framework.resource.syntax.operator.Operator}
     */
    ...
    /**
     * Represents random {@link org.panda_lang.framework.interpreter.token.PandaToken}
     */
