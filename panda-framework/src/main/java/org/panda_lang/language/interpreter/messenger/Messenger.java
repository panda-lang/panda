...
public interface Messenger extends LoggerHolder {
     ...
     * @param message the message to send
     *
     * @see org.panda_lang.language.interpreter.messenger.Messenger#send(Level, java.lang.Object)
     */
     ...
     * Default output listener sends messages through {@link org.panda_lang.language.PandaFramework#getLogger()}
     *
