...
import org.panda_lang.panda.language.resource.expression.ExpressionContextUtils;
...
public class OperationExpressionBenchmark {
    ...
    public void setup() {
        ...
        this.expression = parser.parse(ExpressionContextUtils.createFakeContext((context -> new HashMap<>())), PandaLexerUtils.convert("1 + 2"));
        this.integer = 1;
        this.integer2 = 2;
    }
