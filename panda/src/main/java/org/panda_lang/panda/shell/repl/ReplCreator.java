...
public final class ReplCreator {
    ...
    public Repl create() throws Exception {
        Supplier<Process> processSupplier = () -> new PandaProcess(context.getComponent(Components.APPLICATION), replScope);
        ThrowingFunction<ProcessStack, Object, Exception> instanceSupplier = stack -> prototypeScope.revive(stack, null);

        return new Repl(context, context.getComponent(Components.EXPRESSION), processSupplier, instanceSupplier);
    }
