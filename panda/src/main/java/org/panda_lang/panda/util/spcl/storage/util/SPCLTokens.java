...
public class SPCLTokens {

    public static Operator VAR = new Operator("@");

    public static Separator COLON = new Separator(':');

    public static Separator DASH = new Separator('-');

    public static Separator LINE = new Separator(System.lineSeparator());

    public static Sequence HASH_COMMENT = new Sequence("Comment", "#", System.lineSeparator());
