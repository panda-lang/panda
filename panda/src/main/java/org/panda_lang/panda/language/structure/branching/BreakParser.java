...
import org.panda_lang.panda.language.structure.branching.statements.Break;
...
public class BreakParser implements UnifiedParser {
    ...
    public void parse(ParserInfo info) {
        ...
        generation.getLayer(ParserGenerationType.HIGHER)
                .delegateImmediately(new BreakDeclarationParserCallback(), info.fork());
    }

    @LocalCallback
    private static class BreakDeclarationParserCallback implements ParserGenerationCallback {
