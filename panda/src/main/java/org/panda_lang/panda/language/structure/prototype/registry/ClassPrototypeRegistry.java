...
public class ClassPrototypeRegistry {

    public ClassPrototypeRegistry() {
        try {
            initialize();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    protected void initialize() throws Exception {
        ...
        Set<Class<?>> annotated = reflections.getTypesAnnotatedWith(ClassPrototypeRegistrationCall.class);
