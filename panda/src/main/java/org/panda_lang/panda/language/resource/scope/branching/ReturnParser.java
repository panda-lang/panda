...
public class ReturnParser extends ParserBootstrap {
    ...
    @Autowired
    void parse(@Component Scope scope, @Component(BootstrapComponents.CURRENT_SOURCE_LABEL) Snippet source, @Src("value") @Nullable Expression value) {
        BranchingUtils.parseBranchingStatement(source, scope, () -> new Return(value));
    }
