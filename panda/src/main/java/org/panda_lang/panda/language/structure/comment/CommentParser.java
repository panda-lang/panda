...
package org.panda_lang.panda.language.structure.comment;
...
public class CommentParser implements UnifiedParser {
    ...
    public void parse(ParserInfo info) {
        ...
        generation.getLayer(ParserGenerationType.HIGHER)
                .delegateImmediately(new CommentParserCallback(), info);
    }

    @LocalCallback
    private static class CommentParserCallback implements ParserGenerationCallback {
