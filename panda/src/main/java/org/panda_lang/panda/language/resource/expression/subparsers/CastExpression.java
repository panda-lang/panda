...
final class CastExpression extends AbstractDynamicExpression {

    private final Expression expression;

    CastExpression(Prototype type, Expression expression) {
        super(type);
    ...
    public Object evaluate(ProcessStack stack, Object instance) {
        return getReturnType().getAssociatedClass().cast(expression.evaluate(stack, instance));
    }
