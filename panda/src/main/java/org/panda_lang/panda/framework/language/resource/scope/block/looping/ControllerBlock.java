...
abstract class ControllerBlock extends AbstractBlock implements PandaControlFlowController {

    public ControllerBlock(Scope parent) {
        super(parent);
    }

    @Override
    public void execute(Flow flow) {
        flow.callFlow(super.getCells(), this);
    }
