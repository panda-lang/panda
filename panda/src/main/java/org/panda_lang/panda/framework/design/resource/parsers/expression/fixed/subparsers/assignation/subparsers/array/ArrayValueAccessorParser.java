...
package org.panda_lang.panda.framework.design.resource.parsers.expression.fixed.subparsers.assignation.subparsers.array;
...
public class ArrayValueAccessorParser implements Parser {
    ...
    public ArrayValueAccessor parse(ParserData data, Snippet source, ArrayValueAccessor.ArrayValueAccessorAction action) {
        ...
        ExpressionParser parser = data.getComponent(PandaComponents.EXPRESSION);
